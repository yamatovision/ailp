// test-ai-flow-with-env.js - AI機能の並列処理フローをテストするスクリプト（.env.local読み込み）
...
if (fs.existsSync(envFilePath)) {
  console.log(`.env.local ファイルを読み込みます: ${envFilePath}`);
  // 環境変数を読み込む
  ...
  console.error(`.env.local ファイルが見つかりません: ${envFilePath}`);
  console.log('CLAUDE_API_KEY 環境変数を直接設定してください');
}
